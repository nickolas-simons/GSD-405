...
enum EGenre
{
	Universal = 0	UMETA(DisplayName = "Universal"),
	Mechanical = 1		UMETA(DisplayName = "Mechanical"),
	Biomutation = 2		UMETA(DisplayName = "Biomutation"),
	Mysticism = 5		UMETA(DisplayName = "Mysticism")
};

UENUM(BlueprintType)
enum EEffectCombinationType
{
	Additive = 0	UMETA(DisplayName = "Additive"),
	Maximum = 1		UMETA(DisplayName = "Maximum"),
	Minimum = 2		UMETA(DisplayName = "Minimum"),
	Stack = 3		UMETA(DisplayName = "Stack")
};
...
public:
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly)
	TEnumAsByte<EEffectCombinationType> EffectCombinationType;
